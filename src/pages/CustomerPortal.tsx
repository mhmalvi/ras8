...
import { CheckCircle, Package, Sparkles, ArrowRight, ArrowLeft, Mail, Hash, Loader2, AlertTriangle, Info, RefreshCw, History, Search, MessageSquare } from "lucide-react";
        ...
        <header className="bg-white border-b border-slate-200 px-4 py-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
              ...
              {(currentStep > 1 && currentStep < 5) || activeTab !== 'new-return' ? (
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4 mb-8">
              ...
              <TabsTrigger value="track-return" className="flex items-center space-x-2">
            ...
            <TabsContent value="track-return">
              <ReturnTracking />
            </TabsContent>
